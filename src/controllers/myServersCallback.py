      ...
      def func(*args):
         ...
         return [
            ...
            self.myServers.buildMyServersCard(
               ...
               iconOS = self.myServersManager.getIcon(properties['os']),
               iconHost = self.myServersManager.getIcon(properties['host']),
               iconHardware = self.myServersManager.getIcon(properties['hardware'])
